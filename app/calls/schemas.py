...
class SCallCreate(BaseModel):
    ...
    name: str = Field('Иванов Иван Иванович', min_length=3, max_length=80, description="Full name of patient, which need help")
    ...
    city: str = Field('Минск', min_length=3, max_length=80, description="City of patient")
    street: str = Field('Леонида Беды', min_length=3, max_length=80, description="Street address of patient")
    ...
    driver_name: str | None = Field('Иванов Никита Сергеевич', min_length=3, max_length=80, description="Full name of driver")
    operator_name: str | None = Field('Коваленко Ольга Михайловна', min_length=3, max_length=80, description="Full name of operator")
    doctor_name: str | None = Field('Степанов Игорь Валерьевич', min_length=3, max_length=80, description="Full name of doctor")
